//Davide D'Alessandri 12.07.2023
...
void OnDataRecv(const uint8_t * mac_addr, const uint8_t *incomingData, int len) {
  ...
  */
  ...
  oldDistance5=distance5;
  oldDistance6=distance6;
  oldDistance7=distance7;
  Serial.print((String) distance0 + 'A' + distance1 + 'B' + distance2 + 'C' + distance3
                    + 'D' + distance4 + 'E' + distance5 + 'F' + distance6 + 'G' + distance7 + 'H');
  

  }else{
    Serial.print((String) oldDistance0 + 'A' + oldDistance1 + 'B' + oldDistance2 + 'C' + oldDistance3 
                    + 'D' + oldDistance4 + 'E' + oldDistance5 + 'F' + oldDistance6 + 'G' + oldDistance7 + 'H');
  }
  ...
  oldDistance10=distance0;
  oldDistance11=distance1;
  oldDistance12=distance2;
  oldDistance13=distance3;
  oldDistance14=distance4;
  oldDistance15=distance5;
  oldDistance16=distance6;
  oldDistance17=distance7;
  Serial.print((String) distance0 + 'I' + distance1 + 'J' + distance2 + 'K' + distance3 
                    + 'L' + distance4 + 'M' + distance5 + 'N' + distance6 + 'O' + distance7 + 'P');

  }else{
    Serial.print((String) oldDistance10 + 'I' + oldDistance11 + 'J' + oldDistance12 + 'K' + oldDistance13 
                    + 'L' + oldDistance14 + 'M' + oldDistance15 + 'N' + oldDistance16 + 'O' + oldDistance17 + 'P');
  }
  ...
  oldDistance20=distance0;
  oldDistance21=distance1;
  oldDistance22=distance2;
  oldDistance23=distance3;
  oldDistance24=distance4;
  oldDistance25=distance5;
  oldDistance26=distance6;
  oldDistance27=distance7;
  Serial.print((String) distance0 + 'Q' + distance1 + 'R' + distance2 + 'S' + distance3 
                    + 'T' + distance4 + 'U' + distance5 + 'V' + distance6 + 'W' + distance7 + 'Z' + '\n');

  }else{
    Serial.print((String) oldDistance20 + 'Q' + oldDistance21 + 'R' + oldDistance22 + 'S' + oldDistance23 
                    + 'T' + oldDistance24 + 'U' + oldDistance25 + 'V' + oldDistance26 + 'W' + oldDistance27 + 'Z' + '\n');
  }
...
void loop() {
  ...
  if(val==1){
    ...
    if (client.connected()){
      ...
      sprintf(val, "%d,%d,%d", minMinDistance, roundedRssiScaled, MinPositionLocation);
