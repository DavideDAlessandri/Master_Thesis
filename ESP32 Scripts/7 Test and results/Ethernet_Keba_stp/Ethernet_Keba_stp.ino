//Davide D'Alessandri 05.12.2023
...
IPAddress server(192,168,100,100); //192,168,0,100 ,192,168,100,100, 192,168,100,103
...
void loop() {
  ...
  if(val==1){
    ...
    if (client.connected()){
      ...
      Serial.print(',');
      Serial.print(minMinDistance);
      Serial.print(',');

      //Hardware stop:
      if (minMinDistance < 100){
